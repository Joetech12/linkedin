      ...
      <div className="flex flex-col border-b-[0.5px] pt-2 ">
        ...
        <div className="flex w-full justify-between items-center px-4 py-3">
          <p className="text-[14px]">
            We're thrilled to announce our most exciting sports partnership with
            McLaren Extreme E! Hear more about our partnership from our CEO
            David Shayer and McLaren's CEO Zak Brown!
          </p>
        </div>

        {/* Post Image / video .... */}
        <div className="mx-[3px]">
          <img src="/feed2.jpg" alt="" className="h-[] mr-2 cursor-pointer" />
        </div>
