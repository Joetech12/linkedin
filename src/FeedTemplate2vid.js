...
function FeedTemplate2vid({ compname, compimage, followers, posttext, tag1, tag2, tag3, tag4, tag5, linktitle, link, postvideo, postlike, postcomment}) {
  return (
...
export default FeedTemplate2vid;
